...
export type StreamEvent =
  ...
  | { type: 'tool_result'; name: string; result: string; status: 'done' | 'error'; id?: string }
  | { type: 'subagent'; taskId: string; label: string; kind: 'tool_call' | 'tool_result'; name: string; args?: any; result?: string; status?: 'done' | 'error'; /** 关联主循环工具调用 id(并行双委派各归各 step) */ toolCallId?: string }
...
export type SdkEvent =
  ...
  | { type: 'tool_call'; name: string; args: any; id?: string }
  | { type: 'tool_result'; name: string; result: string; status: 'done' | 'error'; id?: string }
  | { type: 'subagent'; taskId: string; label: string; kind: 'tool_call' | 'tool_result'; name: string; args?: any; result?: string; status?: 'done' | 'error'; toolCallId?: string }
  | { type: 'done'; content: string }
