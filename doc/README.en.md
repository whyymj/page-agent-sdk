...
- **Self-tests**: `npm test` (`../src/core/__tests__/selftest.ts`, 1967 assertions) + `npm run test:e2e` (integration e2e, 596 assertions) + `npm run test:browser` (browser E2E, 54 assertions)
