...
- **Self-tests**: `npm test` (`../src/core/__tests__/selftest.ts`, 1931 assertions) + `npm run test:e2e` (integration e2e, 569 assertions) + `npm run test:browser` (browser E2E, 53 assertions)
