...
- **Self-tests**: `npm test` (`../src/core/__tests__/selftest.ts`, 3465 assertions) + `npm run test:e2e` (integration e2e, 1094 assertions) + `npm run test:browser` (browser E2E, 153 assertions)
