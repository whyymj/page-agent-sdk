...
- **Self-tests**: `npm test` (`../src/core/__tests__/selftest.ts`, 2006 assertions) + `npm run test:e2e` (integration e2e, 605 assertions) + `npm run test:browser` (browser E2E, 54 assertions)
