...
- **Self-tests**: `npm test` (`../src/core/__tests__/selftest.ts`, 2222 assertions) + `npm run test:e2e` (integration e2e, 718 assertions) + `npm run test:browser` (browser E2E, 71 assertions)
