...
- **Self-tests**: `npm test` (`../src/core/__tests__/selftest.ts`, 3473 assertions) + `npm run test:e2e` (integration e2e, 1103 assertions) + `npm run test:browser` (browser E2E, 153 assertions)
