...
- **Self-tests**: `npm test` (`../src/core/__tests__/selftest.ts`, 2192 assertions) + `npm run test:e2e` (integration e2e, 698 assertions) + `npm run test:browser` (browser E2E, 71 assertions)
