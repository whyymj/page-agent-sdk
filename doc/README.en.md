...
- **Self-tests**: `npm test` (`../src/core/__tests__/selftest.ts`, 2042 assertions) + `npm run test:e2e` (integration e2e, 617 assertions) + `npm run test:browser` (browser E2E, 56 assertions)
