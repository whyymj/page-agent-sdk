...
import { run as run_sec_113 } from './modules/sec-113'
import { run as run_sec_114 } from './modules/sec-114'
import { run as run_sec_115 } from './modules/sec-115'
import { run as run_sec_116 } from './modules/sec-116'
import { run as run_sec_117 } from './modules/sec-117'
import { run as run_sec_118 } from './modules/sec-118'
import { run as run_sec_119 } from './modules/sec-119'
import { run as run_sec_120 } from './modules/sec-120'
import { run as run_sec_121 } from './modules/sec-121'
import { run as run_sec_122 } from './modules/sec-122'
import { run as run_sec_123 } from './modules/sec-123'
import { run as run_sec_124 } from './modules/sec-124'
import { run as run_sec_125 } from './modules/sec-125'
import { run as run_sec_126 } from './modules/sec-126'
import { run as run_sec_127 } from './modules/sec-127'
import { run as run_sec_128 } from './modules/sec-128'
import { run as run_sec_129 } from './modules/sec-129'
import { run as run_sec_130 } from './modules/sec-130'
import { run as run_sec_131 } from './modules/sec-131'
import { run as run_sec_132 } from './modules/sec-132'
import { run as run_sec_134 } from './modules/sec-134'
import { run as run_sec_135 } from './modules/sec-135'
...
await run_sec_113(ctx)
await run_sec_114(ctx)
await run_sec_115(ctx)
await run_sec_116(ctx)
await run_sec_117(ctx)
await run_sec_118(ctx)
await run_sec_119(ctx)
await run_sec_120(ctx)
await run_sec_121(ctx)
await run_sec_122(ctx)
await run_sec_123(ctx)
await run_sec_124(ctx)
await run_sec_125(ctx)
await run_sec_126(ctx)
await run_sec_127(ctx)
await run_sec_128(ctx)
await run_sec_129(ctx)
await run_sec_130(ctx)
await run_sec_131(ctx)
await run_sec_132(ctx)
await run_sec_134(ctx)
await run_sec_135(ctx)
