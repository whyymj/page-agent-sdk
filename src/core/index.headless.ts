...
export { createHtmlSubagent, createHtmlFormatCheck, createCraftNoteCheck } from './sdk/htmlSubagent'
...
// 图片输入(image-input-vision):headless 自建 UI 的集成方用 compressImage 制备 AgentImage(headless 无 ChatInput 组件)
