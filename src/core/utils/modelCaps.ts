...
const MODEL_TABLE: Array<{ pattern: RegExp; caps: ModelCaps }> = [
  ...
  { pattern: /deepseek-flash/i, caps: { contextWindow: 1048576, maxOutputTokens: 393216, thinking: true, vision: true } }, // 官方 V4 flash 档(2026-09-18 实测:270K token prompt 200 OK + API 自报输出上限 [1,393216];vision:true = 2026-09-19 双协议图像块实测〔OpenAI content parts 答「蓝色」/ Anthropic image block 答「红色」,1×1 像素〕;须在 generic /deepseek/i 之前 —— 其 128K 低估会撞 MIN_CONTEXT_WINDOW 200K 地板把可用模型误拒)
