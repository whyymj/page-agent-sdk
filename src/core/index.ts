...
export { presets, systemPromptHelpers, extractSchemaHint, htmlOrchestratorPrompt } from './presets'
...
export { domTools, getDomTool, domToStructure, domSearchTool, domInfoTool, domInspectSkill, searchDom, getElementInfo, buildCssPath, ensureDomListenerRecorder, getRecordedListeners, DEFAULT_COMPUTED_STYLES } from './tools/domTool'
export type { DomNode, DomReadOptions, DomSearchHit, DomElementInfo, ElementInfoOptions } from './tools/domTool'
...
// 对话框文案集(dialog.locale / dialog.messages;L2 自建 UI 亦可复用 resolveDialogMessages)
export { MESSAGES_ZH_CN, MESSAGES_EN_US, resolveDialogMessages } from './components/messages'
export type { DialogMessages, DialogLocale } from './components/messages'
