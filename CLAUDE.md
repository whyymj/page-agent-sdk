...
npm run test          # 自测(tsx 跑 src/__tests__/selftest.ts,3793 项断言)
...
```bash
npm test    # tsx 跑 src/core/__tests__/selftest.ts,3793 项断言
```
...
```bash
npm run build && npm run test:e2e    # node 跑 dist 产物,1287 项
```
